...
export class AppComponent {
  ...
  //function for validate email
	...
	public download_CSV(csvDataList) {
		...
		this.csvExportService.exportData(csvDataList, new IgxCsvExporterOptions("downloadCompleteCSV", CsvFileTypes.CSV));
	...
	changePassword() {
        ...
        if (this.txtCrntPassword == "") {
            this.toastr.errorToastr('Please Enter Old Password', 'Oops!', { toastTimeout: (2500) });
            return false;
        }
            ...
            var data = { "indvdlID": this.empId, "oldPassword": this.txtCrntPassword, "newPassword": this.txtNewPassword };
