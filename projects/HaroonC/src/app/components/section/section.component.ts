...
export class SectionComponent implements OnInit {
    ...
    getSectionDetails() {
        ...
        this.http.get(this.serverUrl + 'api/getSectionDetail', { headers: reqHeader }).subscribe((data: any) => {            
    ...
    generatePin(item) {
        ...
        if (this.app.pin != "") {
            ...
            this.http.put(this.serverUrl + "api/deleteSection", deptData) .subscribe((data: any) => {
                if ( data.msg != "Section Successfully Activated!" && data.msg != "Section Successfully Deactivated!" ) 
                {
