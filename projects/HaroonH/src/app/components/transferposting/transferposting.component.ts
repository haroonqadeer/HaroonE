...
export class TransferpostingComponent implements OnInit {
    ...
    serverUrl = "http://192.168.200.19:9029/";
    tokenKey = "token";
    ...
    save() {
        ...
        if (this.ddlEmployee1 == undefined || this.ddlEmployee1 == "") {
            this.toastr.errorToastr('Please select employee 1', 'Error', { toastTimeout: (2500) });
            return false;
        } else if (this.ddlEmployee2 == undefined || this.ddlEmployee2 == "") {
            this.toastr.errorToastr('Please select employee 2', 'Error', { toastTimeout: (2500) });
            return false;
    ...
    getFilterItem(filterOption) {
        ...
        if(filterOption == "filteremp1"){
            ...
            new_dataList = this.emp1List.filter(x => x.payGradeName == dataList[0].payGradeName && x.value != this.ddlEmployee1);
