...
export class LeaverulesComponent implements OnInit {
  ...
  serverUrl = "http://52.163.189.189:9014/";
  ...
  getLeaveLimitType() {
    ...
    this.http
      .get(this.serverUrl + "api/getLeaveLimit", { headers: reqHeader })
      .subscribe((data: any) => {
  ...
  save() {
    ...
    if (this.leaveType == "") {
      ...
      this.toastr.errorToastr("Please enter leave limit type", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (limitType == 1 && leaveLimit > 10) {
      this.toastr.errorToastr(
        "Leave limit exceeded. Maximum 10 allowed.",
        "Error",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.toastr.errorToastr(
        "Leave limit exceeded. Maximum 25 allowed.",
        "Error",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.toastr.errorToastr(
        "Leave limit exceeded. Maximum 40 allowed.",
        "Error",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.toastr.errorToastr(
        "Leave limit exceeded. Maximum 60 allowed.",
        "Error",
        { toastTimeout: 2500 }
      );
      return false;
  ...
  //         completeDataList,
  //         new IgxCsvExporterOptions("LeaveRulesCompleteCSV", CsvFileTypes.CSV)
  //       );
  //     }
  ...
  //       for (var i = 0; i < this.leaveRuleList.length; i++) {
  //         if (
  //           this.leaveRuleList[i].leaveTypeName
  //             .toUpperCase()
  //             .includes(this.tblSearch.toUpperCase()) ||
  //           this.leaveRuleList[i].leaveNatureName
  //             .toUpperCase()
  //             .includes(this.tblSearch.toUpperCase()) ||
  //           this.leaveRuleList[i].leaveLmtName
  //             .toUpperCase()
  //             .includes(this.tblSearch.toUpperCase()) ||
  ...
  //         this.csvExportService.exportData(
  //           filteredDataList,
  //           new IgxCsvExporterOptions("LeaveRulesFilterCSV", CsvFileTypes.CSV)
  //         );
  //       } else {
  ...
  //         new IgxExcelExporterOptions("LeaveRulesCompleteExcel")
  //       );
  //       this.excelDataList = [];
  //     }
  //     // case 2: When tblSearch is not empty then assign new data list
  ...
  //         this.excelExportService.export(
  //           this.excelDataContent,
  //           new IgxExcelExporterOptions("LeaveRulesFilterExcel")
  //         );
  //         this.excelDataList = [];
  //       } else {
  //         this.toastr.errorToastr("Oops! No data found", "Error", {
