...
export class PerformanceEvaComponent implements OnInit {
  ...
  // @ViewChild("excelDataContentReviews")
  // public excelDataContentReviews: IgxGridComponent; //For excel
  // @ViewChild("excelDataContentGoals")
  // public excelDataContentGoals: IgxGridComponent; //For excel
  // @ViewChild("excelDataContentSkills")
  // public excelDataContentSkills: IgxGridComponent; //For excel
  ...
  getSupervisor() {
    ...
    this.http
      .get(this.serverUrl + "api/getSupervisor", { headers: reqHeader })
      .subscribe((data: any) => {
  ...
  getSkillsName() {
    ...
    this.http
      .get(this.serverUrl + "api/getSkillsName", { headers: reqHeader })
      .subscribe((data: any) => {
        //this.skillsNameList = data;

        for (var i = 0; i < data.length; i++) {
          this.skillsNameList.push({
  ...
  getProjectsPerformanceData() {
    ...
    this.http
      ...
      .subscribe((data: any) => {
        ...
        if (this.calFunFlag == "Yes") {
          this.tempListProjectsPerformanceData(this.employeeName);
        }
        this.app.hideSpinner();
      });
    ...
    //     i = this.projectsPerformanceData.length + 1;
    //   }
    // }

    // alert('After temp project tempID ' + this.tempIndvdlId);
  }
  ...
  tempListProjectsPerformanceData(tempIndvdlId) {
    // alert('id ' + tempIndvdlId);
    // alert('length ' + this.projectsPerformanceData.length);

    for (let i = 0; i < this.projectsPerformanceData.length; i++) {
      //alert(tempIndvdlId + ' - ' + this.projectsPerformanceData[i].indvdlID)
      if (tempIndvdlId == this.projectsPerformanceData[i].indvdlID) {
        this.tempProjectsPerformanceData = [];
        //alert('ok');
  ...
  tempListSkillsPerformanceData(tempIndvdlId) {
    this.tempSkillsPerformanceData = [];
    this.skillsList = [];
    ...
    for (let i = 0; i < this.skillsPerformanceData.length; i++) {
      if (tempIndvdlId == this.skillsPerformanceData[i].indvdlID) {
        ...
        this.skillsList.push({
          SkillDate: this.skillsPerformanceData[i].skillDt,
          QlfctnSkillName: this.skillsPerformanceData[i].qlfctnCriteriaName,
          SkillCd: this.skillsPerformanceData[i].skillCd,
          SkillTypeCd: this.skillsPerformanceData[i].skillTypeCd,
          SkillCriteriaCd: this.skillsPerformanceData[i].skillsCriteriaCd,
          RateSkillLevel: this.skillsPerformanceData[i].skillLvl,
  ...
  addReviews() {
    if (this.reviewDate == undefined || this.reviewDate == "") {
      ...
      this.rateJobKnowledge == undefined ||
      ...
      this.rateCommunication == undefined ||
      ...
      this.rateDependability == undefined ||
  ...
  addGoals() {
    ...
    // }
      ...
      this.rateSprvsrAssessment == undefined ||
      ...
      var duplicateChk = false;
      //alert(this.tempProjectsPerformanceData.length);
      for (var i = 0; i < this.tempProjectsPerformanceData.length; i++) {
        if (
          this.tempProjectsPerformanceData[i].SupervisorId ==
          this.supervisorName
        ) {
          //alert(this.projectsList[i].SupervisorName + " - " + this.supervisorName);
          duplicateChk = true;
        }
      }
      ...
      if (duplicateChk == true) {
        ...
        for (var i = 0; i < this.supervisorList.length; i++) {
          if (this.supervisorName == this.supervisorList[i].value) {
            this.supervisor = this.supervisorList[i].label;
          }
        }
  ...
  addSkills() {
    if (this.skillDate == undefined || this.skillDate == "") {
      ...
      this.skillCriteriaCd == undefined ||
      ...
      for (var i = 0; i < this.skillsList.length; i++) {
        if (
          this.skillsList[i].SkillCriteriaCd == this.skillCriteriaCd &&
          this.skillsList[i].SkillDate == this.skillDate
        ) {
          duplicateChk = true;
        }
      }
  ...
  editProjects(item) {
    ...
    this.supervisorName = item.SupervisorId;
  ...
  saveProjects() {
    ...
    // }
      ...
      var saveData = {
        ...
        finishDate: this.finishDate,
        projectDesc: this.projectDesc,
        // "projectTypeCd": this.projectTypeCd, // To Project Type Cd
  ...
  deleteProjects(item) {
    ...
    this.clearProjects();
    this.dProjectsId = item.IndvdlID;
    this.companyId = item.CmpnyID;
    this.jobDesigId = item.JobDesigID;
    //this.skillCriteriaCd = item.skillCriteriaCd;
  }
  ...
  delete() {
    ...
    if (this.userPassword == "") {
      ...
      //*--- For Projects
      if (this.dProjectsId != "") {
        //alert(this.dProjectsId);
        // alert('EmpId ' + this.employeeName);
        // alert('jobId ' + this.jobDesigId);
        // alert('ComId ' + this.companyId);
  ...
  clearProjects() {
    ...
    this.supervisorName = "";
    this.rateSprvsrAssessment = "";
    // ngModels for delete modal window
    this.userPassword = "";
    this.userPINCode = "";
  }
  ...
  //       completeDataList,
  //       new IgxCsvExporterOptions("ReviewsCompleteCSV", CsvFileTypes.CSV)
  //     );
  //   }
  ...
  //     for (var i = 0; i < this.reviewsList.length; i++) {
  //       if (
  //         this.reviewsList[i].EmployeeName.toUpperCase().includes(
  //           this.tblSearchReviews.toUpperCase()
  //         )
  //       ) {
  ...
  //       this.csvExportService.exportData(
  //         filteredDataList,
  //         new IgxCsvExporterOptions("ReviewsFilterCSV", CsvFileTypes.CSV)
  //       );
  //     } else {
  ...
  //       this.excelDataContentReviews,
  //       new IgxExcelExporterOptions("ReviewsCompleteExcel")
  //     );
  ...
  //       this.excelExportService.export(
  //         this.excelDataContentReviews,
  //         new IgxExcelExporterOptions("ReviewsFilterExcel")
  //       );
  //       this.excelDataListReviews = [];
  //     } else {
  //       this.toastr.errorToastr("Oops! No data found", "Error", {
  ...
  //       //alert(this.tblSearchType + " - " + this.skillCriteriaList[i].departmentName)
  //       completeDataList.push({
  //         StartDate: this.tempProjectsPerformanceData[i].StartDate,
  //         FinishDate: this.tempProjectsPerformanceData[i].FinishDate,
  //         ProjectDesc: this.tempProjectsPerformanceData[i].ProjectDesc,
  //         SupervisorName: this.tempProjectsPerformanceData[i].SupervisorName,
  //         RateSprvsrAssessment: this.tempProjectsPerformanceData[i]
  //           .RateSprvsrAssessment
  //       });
  //     }
  //     this.csvExportService.exportData(
  //       completeDataList,
  //       new IgxCsvExporterOptions("GoalsCompleteCSV", CsvFileTypes.CSV)
  //     );
  //   }
  //   // case 2: When tblSearchType is not empty then assign new data list
  ...
  //         this.tempProjectsPerformanceData[
  //           i
  //         ].SupervisorName.toUpperCase().includes(
  //           this.tblSearchGoals.toUpperCase()
  //         )
  //       ) {
  //         filteredDataList.push({
  //           StartDate: this.tempProjectsPerformanceData[i].StartDate,
  ...
  //       this.csvExportService.exportData(
  //         filteredDataList,
  //         new IgxCsvExporterOptions("GoalsFilterCSV", CsvFileTypes.CSV)
  //       );
  //     } else {
  //       this.toastr.errorToastr("Oops! No CSV data found", "Error", {
  //         toastTimeout: 2500
  //       });
  //     }
  //   }
  ...
  //     }
  //     this.excelExportService.export(
  //       this.excelDataContentGoals,
  //       new IgxExcelExporterOptions("GoalsCompleteExcel")
  //     );
  ...
  //       this.excelExportService.export(
  //         this.excelDataContentGoals,
  //         new IgxExcelExporterOptions("GoalsFilterExcel")
  //       );
  //       this.excelDataListGoals = [];
  //     } else {
  //       this.toastr.errorToastr("Oops! No Excel data found", "Error", {
  //         toastTimeout: 2500
  //       });
  //     }
  //   }
  ...
  //     this.csvExportService.exportData(
  //       completeDataList,
  //       new IgxCsvExporterOptions("SkillsCompleteCSV", CsvFileTypes.CSV)
  //     );
  //   }
  //   // case 2: When tblSearchType is not empty then assign new data list
  ...
  //     for (var i = 0; i < this.skillsList.length; i++) {
  //       if (
  //         this.skillsList[i].QlfctnSkillName.toUpperCase().includes(
  //           this.tblSearchSkills.toUpperCase()
  //         )
  //       ) {
  //         filteredDataList.push({
  //           SkillDate: this.skillsList[i].SkillDate,
  ...
  //       this.csvExportService.exportData(
  //         filteredDataList,
  //         new IgxCsvExporterOptions("SkillsFilterCSV", CsvFileTypes.CSV)
  //       );
  //     } else {
  //       this.toastr.errorToastr("Oops! No CSV data found", "Error", {
  //         toastTimeout: 2500
  ...
  //     }
  //     this.excelExportService.export(
  //       this.excelDataContentSkills,
  //       new IgxExcelExporterOptions("SkillsCompleteExcel")
  //     );
  ...
  //       this.excelExportService.export(
  //         this.excelDataContentSkills,
  //         new IgxExcelExporterOptions("SkillsFilterExcel")
  //       );
  //       this.excelDataListSkills = [];
  //     } else {
  //       this.toastr.errorToastr("Oops! No Excel data found", "Error", {
