...
export class CommunicationComponent implements OnInit {
    ...
    constructor( public toastr: ToastrManager, private app: AppComponent, private http: HttpClient ) {}
    ...
    getDocument() {
        ...
        this.http.get(this.serverUrl + 'api/getDocument', { headers: reqHeader }).subscribe((data: any) => {
    ...
    delete(item) {
        ...
        if (this.app.pin != "") {
            ...
            this.http.post(this.serverUrl + 'api/uploadDocument', delData, { headers: reqHeader }).subscribe((data: any) => {
