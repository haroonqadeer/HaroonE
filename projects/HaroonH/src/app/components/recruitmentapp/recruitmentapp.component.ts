...
export class RecruitmentappComponent implements OnInit {
  ...
  serverUrl = "http://52.163.189.189:9025/";
  ...
  getRecruitmentApps() {
    ...
    this.http
      .get(this.serverUrl + "api/getRecruitmentApprovalMain", {
        headers: reqHeader
      })
      .subscribe((data: any) => {
  ...
  getPubChannel() {
    ...
    this.http
      .get(this.serverUrl + "api/getPubChannel", { headers: reqHeader })
      .subscribe((data: any) => {
  ...
  getApprProcess() {
    ...
    this.http
      .get(this.serverUrl + "api/getApprProcess", { headers: reqHeader })
      .subscribe((data: any) => {
        for (var i = 0; i < data.length; i++) {
  ...
  getApprAuthority() {
    ...
    this.http
      .get(this.serverUrl + "api/getApprAuthority", { headers: reqHeader })
      .subscribe((data: any) => {
        for (var i = 0; i < data.length; i++) {
  ...
  getSubjct() {
    ...
    this.http
      .get(this.serverUrl + "api/getTestSubject", { headers: reqHeader })
      .subscribe((data: any) => {
        for (var i = 0; i < data.length; i++) {
  ...
  getJobPostVacancyId() {
    if (
      ...
      this.http
        .post(this.serverUrl + "api/getJobPostVacancyId", reqData, {
          headers: reqHeader
        })
        .subscribe((data: any) => {
          if (data.msg != "Done") {
  ...
  getJobPostVacancyDetail() {
    if (
      this.ddlJobPostVacancyId == undefined ||
      ...
      this.http
        .post(this.serverUrl + "api/getJobPostVacancyDetail", reqData, {
          headers: reqHeader
        })
        .subscribe((data: any) => {
          if (data.msg != "Done") {
            ...
            this.JobPostVcncyFnnclImpct =
              data.vcncyDetlList[0].jobPostVcncyFnnclImpct;
  ...
  addPubChannel() {
    if (this.ddlPubChannel == undefined || this.ddlPubChannel == "") {
      this.toastr.errorToastr("Please select publishing channel", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      for (var i = 0; i < this.publishingChannelList.length; i++) {
        if (
          this.publishingChannelList[i].pblshngChnnlCd == this.ddlPubChannel
        ) {
          duplicateChk = true;
        }
      }
      ...
      if (duplicateChk == true) {
        this.toastr.errorToastr("Publishing channel already added", "Error", {
          toastTimeout: 2500
        });
        return false;
      } else {
        var dataList = [];
        dataList = this.tempPublishingChannelList.filter(
          x => x.value == this.ddlPubChannel
        );
  ...
  addApprAuthority() {
    if (this.ddlApprProcess == undefined || this.ddlApprProcess == "") {
      this.toastr.errorToastr("Please select approval stage", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (
      this.ddlApprAuthority == undefined ||
      this.ddlApprAuthority == ""
    ) {
      this.toastr.errorToastr("Please select approving authority", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      for (var i = 0; i < this.approvalReqList.length; i++) {
        if (
          this.approvalReqList[i].actlApprvngAthrtyEmpID ==
            this.ddlApprAuthority &&
          this.approvalReqList[i].apprvngPrcssCd == this.ddlApprProcess
        ) {
          duplicateChk = true;
        }
      }
      ...
      if (duplicateChk == true) {
        this.toastr.errorToastr("Stage and authority already added", "Error", {
          toastTimeout: 2500
        });
        return false;
      } else {
        var dataList = [];
        dataList = this.apprProcessList.filter(
          x => x.value == this.ddlApprProcess
        );

        var dataList1 = [];
        dataList1 = this.apprAuthorigyList.filter(
          x => x.value == this.ddlApprAuthority
        );
  ...
  addInterviewPanel() {
    if (
      this.ddlInterviewOfficial == undefined ||
      this.ddlInterviewOfficial == ""
    ) {
      this.toastr.errorToastr("Please select official", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      if (duplicateChk == true) {
        this.toastr.errorToastr("Official already added", "Error", {
          toastTimeout: 2500
        });
        return false;
      } else {
        var dataList = [];
        dataList = this.apprAuthorigyList.filter(
          x => x.value == this.ddlInterviewOfficial
        );
  ...
  addTest() {
    if (this.ddlSubject == undefined || this.ddlSubject == "") {
      this.toastr.errorToastr("Please select subject", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (this.totalMarks == undefined || this.totalMarks == "") {
      this.toastr.errorToastr("Please enter total marks", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (this.passingMarks == undefined || this.passingMarks == "") {
      this.toastr.errorToastr("Please enter passing marks", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (this.totalMarks <= 0 || this.totalMarks > 100) {
      this.toastr.errorToastr("Invalid total marks", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else if (this.passingMarks <= 0 || this.passingMarks > 100) {
      this.toastr.errorToastr("Invalid passing marks", "Error", {
        toastTimeout: 2500
      });
      return false;
      ...
      if (duplicateChk == true) {
        this.toastr.errorToastr("Subject already added", "Error", {
          toastTimeout: 2500
        });
        return false;
      } else {
  ...
  savePubChannel() {
    if (this.VacancyId == "" || this.VacancyId == undefined) {
      ...
      this.toastr.errorToastr("Please enter publishing channel", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      this.http
        .post(this.serverUrl + "api/savePubChannel", saveData, {
          headers: reqHeader
        })
        .subscribe((data: any) => {
  ...
  saveRequest() {
    if (this.JobDesigID == undefined || this.JobDesigID == "") {
      ...
      this.jobPostVacancyFlag == true &&
      (this.ddlJobPostVacancyId == undefined || this.ddlJobPostVacancyId == "")
    ) {
      this.toastr.errorToastr("Please select job post vacancy id", "Error", {
        toastTimeout: 2500
      });
      return false;
      ...
      this.toastr.errorToastr("Please enter end date", "Error", {
        toastTimeout: 2500
      });
      return false;
    ...
    // }
      ...
      if (this.jobPostVacancyFlag == true) {
        ...
        this.http
          .post(this.serverUrl + "api/saveRequest", updateData, {
            headers: reqHeader
          })
          .subscribe((data: any) => {
        ...
        this.http
          .post(this.serverUrl + "api/saveRequest", saveData, {
            headers: reqHeader
          })
          .subscribe((data: any) => {
            if (data.msg != "Record Saved Successfully!") {
  ...
  saveApprAuthority() {
    if (this.JobPostVcncyID == undefined || this.JobPostVcncyID == "") {
      ...
      this.toastr.errorToastr(
        "Please enter approving authority detail",
        "Error",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.http
        .post(this.serverUrl + "api/saveApproval", saveData, {
          headers: reqHeader
        })
        .subscribe((data: any) => {
          if (data.msg != "Record Saved Successfully!") {
  ...
  saveInterviewPanel() {
    if (this.JobPostVcncyID == undefined || this.JobPostVcncyID == "") {
      ...
      this.toastr.errorToastr("Please enter interview panel detail", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      this.http
        .post(this.serverUrl + "api/saveInterviewPanel", saveData, {
          headers: reqHeader
        })
        .subscribe((data: any) => {
          if (data.msg != "Record Saved Successfully!") {
  ...
  saveTest() {
    if (this.JobPostVcncyID == undefined || this.JobPostVcncyID == "") {
      ...
      this.toastr.errorToastr("Please enter test detail", "Error", {
        toastTimeout: 2500
      });
      return false;
    } else {
      ...
      this.http
        .post(this.serverUrl + "api/saveTest", saveData, { headers: reqHeader })
        .subscribe((data: any) => {
          if (data.msg != "Record Saved Successfully!") {
            this.app.hideSpinner();
            this.toastr.errorToastr(data.msg, "Error!", { toastTimeout: 5000 });
  ...
  getDetail(item) {
    ...
    this.totalVacancies =
      item.vacancies1 + item.vacancies2 - (item.request + item.process);
