...
export class TrainingemployeeComponent implements OnInit {
  ...
  getEmployeeJobTraining() {
    ...
    this.http
      .get(this.serverUrl + "api/getEmployeeJobTraining", {
        headers: reqHeader
      })
      .subscribe((data: any) => {
  ...
  //     for (var i = 0; i < this.empJobTrainingList.length; i++) {
  //       if (
  //         this.empJobTrainingList[i].indvdlFullName
  //           .toUpperCase()
  //           .includes(this.tblSearch.toUpperCase()) ||
  //         this.empJobTrainingList[i].jobDesigName
  //           .toUpperCase()
  //           .includes(this.tblSearch.toUpperCase()) ||
  //         this.empJobTrainingList[i].trnngName
  //           .toUpperCase()
  //           .includes(this.tblSearch.toUpperCase()) ||
  //         this.empJobTrainingList[i].orgName
  //           .toUpperCase()
  //           .includes(this.tblSearch.toUpperCase())
  //       ) {
  ...
  //       new IgxExcelExporterOptions("trainingEmployeeCompleteExcel")
  //     );
  //     this.excelDataList = [];
  //   }
  //   // case 2: When tblSearch is not empty then assign new data list
  ...
  //       this.excelExportService.export(
  //         this.excelDataContent,
  //         new IgxExcelExporterOptions("trainingEmployeeFilterExcel")
  //       );
  //       this.excelDataList = [];
  //     } else {
  //       this.toastr.errorToastr("Oops! No data found", "Error", {
